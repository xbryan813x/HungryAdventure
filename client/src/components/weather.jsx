            ...
            <div id="card" className="weater">
              <div className="city-selected">
                <article>
                  ...
                  <div className="info">
                    <div className="city"><span>City:</span> Skopje</div>
                  ...
                  <div className="icons">
                    <svg id="icon" style={{ enableBackground: 'new 0 0 59.077 59.077' }} version="1.1" viewBox="0 0 59.077 59.077" x="0px" y="0px" xmlSpace="preserve">
                      <g>
                ...
                <figure style={{ backgroundImage: 'url("http://136.243.1.253/~creolitic/bootsnipp/home.jpg")' }} className="weather" />
              </div>
...
=======
         ...
         <figure style={{ backgroundImage: `url(${herojpg})` }}></figure>
         </div>
